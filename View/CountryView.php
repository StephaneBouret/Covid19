...
class CountryView extends View
{
    ...
    public function displayHome($listCountries,$infection,$worldDeath,$worldHealing,$worldPopulation)
    {
        ...
        $this->page .= "<div class='d-flex justify-content-between mb-3'><p class='mb-0'><a href='index.php?controller=country&action=automaticUpload'><button type='button' class='btn btn-primary'>Mettre à jour</button></a></p><p class='mb-0'><a href='index.php?controller=country&action=clearBdd'><button type='button' class='btn btn-danger'><i class='far fa-trash-alt'></i> Vider la table</button></a></p>
